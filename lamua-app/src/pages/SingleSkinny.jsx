  ...
  return (
    <div className='pt-[95px]' >
     ...
     <ImageHero
      ...
      />
      <div className='min-w-[390px] max-w-[639px] flex items-center justify-center mt-20'>
...
<path d="M0.494063 16.3275L7.82156 9.00002L0.494063 1.67252C0.168646 1.3471 0.168646 0.819601 0.494062 0.494185C0.819479 0.168768 1.34698 0.168768 1.6724 0.494185L9.58906 8.41085C9.75198 8.57377 9.83323 8.78668 9.83323 9.00002C9.83323 9.21335 9.75198 9.42627 9.58906 9.58918L1.6724 17.5059C1.34698 17.8313 0.81948 17.8313 0.494063 17.5059C0.168647 17.1804 0.168647 16.6529 0.494063 16.3275Z" fill="#312651"/>
        ...
        <div className=" min-w-[390px] max-w-[639px] h-[194px] rounded-[8px] flex items-center justify-center mt-7">
     <div className="relative w-[342px] h-[194px] rounded-[8px] overflow-hidden">
  {/* ویدیو */}
  <video
  ...
  <div className="absolute top-2 right-2 w-[20px] h-[20px] flex items-center justify-center rounded-full bg-white/70 cursor-pointer">
    ...
    <div className="desc min-w-[390px] max-w-[639px] h-[194px] rounded-[8px] flex items-center justify-center mt-7">
      <p className="w-[342px] h-[132px] text-justify text-[#312651] text-[13px] leading-[22px] font-light font-[IranSans]" dir='rtl'>
  اگر تو یکی از زنانی هستی که مسیر «7 مرحله شکوفایی زنانه» را تجربه کرده ای، می دانی که آن سفر ساده نبود؛ سفری بود به عمق وجود، به روبرو شدن با صدای خاموش شده، لایه های زخمی و دخترک درون که سال ها بی صدا مانده بود. در آن مسیر، در آینه به خودت گفتی: «من کامل هستم، همین طور که هستم.»
    ...
    <div className="exp min-w-[390px] max-w-[639px] h-[194px] rounded-[8px] flex items-center justify-center mt-8">
      <div className="flex flex-col items-start p-0 gap-4 w-[342px] h-[331px]">
        <div className="flex flex-row justify-end items-center p-0 gap-4 w-[342px] h-[29px]">
          <h2 className="w-[214px] h-[29px] text-right text-[#312651] text-[18px] leading-[32px] font-bold tracking-[-0.04em] font-[YekanBakh-Bold]">
...
<stop offset="1" stop-color="#6A4BC4"/>
        ...
        <p className="w-[342px] h-[286px] text-justify text-[#312651] text-[13px] leading-[22px] font-light font-[IranSans]" dir='rtl'>
  ...
  لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و با استفاده از طراحان گرافیک است، چاپگرها و متون بلکه روزنامه و مجله در ستون و سطر آنچنان که لازم است، و برای شرایط فعلی تکنولوژی مورد نیاز، و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می‌باشد...
    ...
    <div className="exp min-w-[390px] max-w-[639px] h-[194px] rounded-[8px] flex items-center justify-center mt-36">
      <div className="flex flex-col items-start p-0 gap-4 w-[342px] h-[331px]">
        <div className="flex flex-row justify-end items-center p-0 gap-4 w-[342px] h-[29px]">
          <h2 className="w-[250px] h-[29px] text-right text-[#312651] text-[18px] leading-[32px] font-bold tracking-[-0.04em] font-[YekanBakh-Bold]">
...
<stop offset="1" stop-color="#6A4BC4"/>
        ...
        <div className="w-[342px] h-[220px] text-[13px] leading-[22px] font-light text-[#312651] text-justify font-[IranSans]" dir='rtl'>
          <p className='mb-6'>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و با استفاده از طراحان گرافیک است، چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است:</p>
          <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و با استفاده از طراحان گرافیک است، چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است</p>
          <p>و برای شرایط فعلی تکنولوژی مورد نیاز
...
<p>کتابهای زیادی در شصت و سه درصد گذشته حال و آینده
     ...
     <div className="exp min-w-[390px] max-w-[639px] h-[194px] rounded-[8px] flex items-center justify-center mt-28">
      <div className="flex flex-col items-start p-0 gap-4 w-[342px] h-[331px]">
        <div className="flex flex-row justify-end items-center p-0 gap-4 w-[342px] h-[29px]">
          <h2 className="w-[214px] h-[29px] text-right text-[#312651] text-[18px] leading-[32px] font-bold tracking-[-0.04em] font-[YekanBakh-Bold]">
...
<stop offset="1" stop-color="#6A4BC4"/>
  ...
  لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و با استفاده از طراحان گرافیک است، چاپگرها و متون بلکه روزنامه و مجله در ستون و سطر آنچنان که لازم است، و برای شرایط فعلی تکنولوژی مورد نیاز، و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می‌باشد...
      ...
      <div className="exp min-w-[390px] max-w-[639px] h-[194px] rounded-[8px] flex items-center justify-center mt-2 mb-20">
      <div className="flex flex-col items-start p-0 gap-4 w-[342px] h-[331px]">
        <div className="flex flex-row justify-end items-center p-0 gap-4 w-[342px] h-[29px]">
          <h2 className="w-[250px] h-[29px] text-right text-[#312651] text-[18px] leading-[32px] font-bold tracking-[-0.04em] font-[YekanBakh-Bold]">
